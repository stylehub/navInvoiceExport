...
/**
 * Class representing CsomszerForgHozTipusType
 *
 * 
 * XSD Type: csomszer_forg_hoz_tipus
 */
class CsomszerForgHozTipusType
{

    /**
     * Amennyiben a csomagolószer termékdíj-köt. az eladót terheli, akkor feltüntetendő:
    ...
    /**
     * True, amennyiben a csomagolás részeként forgalomba hozott csomszer.termékdíj. köt. az eladót terheli.
     *
    ...
    /**
     * Amennyiben az eladót a vevő nyilatkozata alapján termékdíj megfizetése nem terheli, akkor:
     ...
     *
     * @property \Dream\NavInvoiceExport\Data\VevoNyilatkozatTipusType $vevoNyilatkozat
     */
     ...
     *  "a csomagolószer termékdíja a vevő...számon iktatott időszakra vonatkozó nyilatkozata alapján nem kerül megfizetésre".
     *
     * @return \Dream\NavInvoiceExport\Data\VevoNyilatkozatTipusType
     */
     ...
     *  "a csomagolószer termékdíja a vevő...számon iktatott időszakra vonatkozó nyilatkozata alapján nem kerül megfizetésre".
     *
     * @param \Dream\NavInvoiceExport\Data\VevoNyilatkozatTipusType $vevoNyilatkozat
     * @return self
     */
    public function setVevoNyilatkozat(\Dream\NavInvoiceExport\Data\VevoNyilatkozatTipusType $vevoNyilatkozat)
    {
