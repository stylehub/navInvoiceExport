...
/**
 * Class representing TermekSzolgaltatasTetelekTipusType
 *
 * 
 * XSD Type: termek_szolgaltatas_tetelek_tipus
 */
class TermekSzolgaltatasTetelekTipusType
{
     ...
     *  A nyújtott szolgáltatás mennyisége, feltéve, hogy az természetes mértékegységben kifejezhető.
     *
    ...
    /**
     * A termék vagy szolgáltatás, feltéve, hogy az természetes mértékegységben kifejezhető, mennyiségi mértékegysége.
     *
    ...
    /**
     * Értékesített termék adó nélküli egységára, a nyújtott szolgáltatás adó nélküli egységára, ha az természetes mértékegységben kifejezhető.
     *
    ...
    /**
     * Bruttó ár. Egyszerűsített adattartalmú számla esetén kötelező, más számlák esetén csak akkor, ha van ilyen adat.
     *
    ...
    /**
     * Csak nyilvános árverés szervezője által kibocsátott számla esetén kell kitölteni.
     ...
     * Csak nyilvános árverés szervezője által kibocsátott számla esetén kell kitölteni.
     *  Az ÁFA törvény 231.§ (2) szerint a 169.§ i. pontja helyetti számla tétel elemek.
     *  Az adók, vámok, illetékek, járulékok, hozzájárulások és más kötelező jellegű befizetések.
     *
     ...
     * Csak nyilvános árverés szervezője által kibocsátott számla esetén kell kitölteni.
     *  Az ÁFA törvény 231.§ (2) szerint a 169.§ i. pontja helyetti számla tétel elemek.
     *  A felmerült járulékos költségek, amit az árverés szervezője hárít át az árverési vevőnek együttes összege.
     *
     * @property float $vktg
     */
    private $vktg = null;
     ...
     *
     * @property \Dream\NavInvoiceExport\Data\KozlEszkInfTipusType $kozlEszkInf
     */
    private $kozlEszkInf = null;

    /**
     * Az ásványolaj adóraktárból történő kitárolása esetén meghatározott esetben fel kell tüntetni a számlán
     *  8/2004. (III. 10.) PM rendelet 80. § (1) bekezdés b)-g) pontjaiban felsorolt adatokat.
     *
     * @property \Dream\NavInvoiceExport\Data\AsvanyolajTipusType $asvanyolaj
     */
     ...
     * Közlekedési eszköz információk.
     *
     * @return \Dream\NavInvoiceExport\Data\KozlEszkInfTipusType
     */
     ...
     * Közlekedési eszköz információk.
     *
     * @param \Dream\NavInvoiceExport\Data\KozlEszkInfTipusType $kozlEszkInf
     * @return self
     */
    public function setKozlEszkInf(\Dream\NavInvoiceExport\Data\KozlEszkInfTipusType $kozlEszkInf)
    {
     ...
     *  8/2004. (III. 10.) PM rendelet 80. § (1) bekezdés b)-g) pontjaiban felsorolt adatokat.
     *
     * @return \Dream\NavInvoiceExport\Data\AsvanyolajTipusType
     */
     ...
     *  8/2004. (III. 10.) PM rendelet 80. § (1) bekezdés b)-g) pontjaiban felsorolt adatokat.
     *
     * @param \Dream\NavInvoiceExport\Data\AsvanyolajTipusType $asvanyolaj
     * @return self
     */
    public function setAsvanyolaj(\Dream\NavInvoiceExport\Data\AsvanyolajTipusType $asvanyolaj)
    {
