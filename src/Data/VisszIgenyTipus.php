...
/**
 * Class representing VisszIgenyTipus
 *
 * 
 * XSD Type: vissz_igeny_tipus
 */
class VisszIgenyTipus
{

    /**
     * Visszaigénylés alapjául megnevezett számla tételei.
     *
     * @property \Dream\NavInvoiceExport\Data\VisszIgenytetelTipus[] $visszIgenytetel
     */
    private $visszIgenytetel = null;
     ...
     * Kötelezett címe.
     *
     * @property \Dream\NavInvoiceExport\Data\CimTipus $kotelezettCime
     */
     ...
     *
     * @return self
     * @param \Dream\NavInvoiceExport\Data\VisszIgenytetelTipus $visszIgenytetel
     */
    public function addToVisszIgenytetel(\Dream\NavInvoiceExport\Data\VisszIgenytetelTipus $visszIgenytetel)
    {
     ...
     * Visszaigénylés alapjául megnevezett számla tételei.
     *
     * @return \Dream\NavInvoiceExport\Data\VisszIgenytetelTipus[]
     */
     ...
     * Kötelezett címe.
     *
     * @param \Dream\NavInvoiceExport\Data\CimTipus $kotelezettCime
     * @return self
     */
    public function setKotelezettCime(\Dream\NavInvoiceExport\Data\CimTipus $kotelezettCime)
    {
