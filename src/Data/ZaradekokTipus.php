...
/**
 * Class representing ZaradekokTipus
 *
 * 
 * XSD Type: zaradekok_tipus
 */
class ZaradekokTipus
{

    /**
     * True, ha pénzforgalmi elszámolás.
     *  Különös szabályok szerinti (ÁFA tv. XIII/A. fejezete) adózás
    ...
    /**
     * True, ha önszámlázás.
     *  Ha a számlát a terméket beszerző vagy a szolgáltatást igénybevevő
     * állítja ki.
     *
     ...
     *  Ha adófizetésre a termék beszerzője, szolgáltatás igénybevevője
     * kötelezett.
     *
    ...
    /**
     * True, ha a termék értékesítése, szolgáltatás nyújtása mentes az adó
     * alól.
     *
    ...
    /**
     * Különbözet szerinti szabályozás - utazási irodák, használt cikkek,
     * műalkotások, gyűjteménydarabok és régiségek közül a megfelelő
     * kifejezés feltüntetése.
     *
    ...
    /**
     * "az egyéb kőolajtermék vevője nem termékdíj-kötelezett, a bruttó árból
     * ……Ft termékdíj átvállalásra került".
     *
    ...
    /**
     * "a termékdíj kötelezettség a Ktdt. 14.§ (5) bekezdés …..)
     * pontja…..)alpontja alapján a vevőt terheli".
     *
     * @property \Dream\NavInvoiceExport\Data\TermekdijSzerzesAtvallalasTipus
     * $termekdijSzerzesAtvallalas
     */
    private $termekdijSzerzesAtvallalas = null;

    /**
     * Feltüntetendő adatok köre:termékdíjköteles termék CsK, KT kódja,
     * termékdíj mértéke, összege,
     *  termékdíj megfizetését (bevallását) igazoló dokumentumok adataiból
     * legalább a következő adatokat:
     ...
     *  kötelezett adószáma.
     *
     * @property \Dream\NavInvoiceExport\Data\VisszIgenyTipus $visszIgeny
     */
    private $visszIgeny = null;

    /**
     * Amennyiben a csomagolószer termékdíj-köt. az eladót terheli, akkor
     * feltüntetendő: "a csomagolószer termékdíj összege bruttó árból…..Ft"
     *  Amennyiben a csomagolás részeként forgalomba hozott csomszer.termékdíj.
     * Köt. Az eladót terheli, akkor: "a csomagolás termékdíj-kötelezettség az
     * eladót terheli"
     *  Amennyiben az eladót a vevő nyilatkozata alapján termékdíj megfizetése
     * nem terheli, akkor: "a csomagolószer termékdíja a veveő eseti nyilatkozata
     * alapján nem kerül megfizetésre" vagy
     *  "a csomagolószer termékdíja a vevő...számon iktatott időszakra vonatkozó
     * nyilatkozata alapján nem kerül megfizetésre".
     *
     * @property \Dream\NavInvoiceExport\Data\CsomszerForgHozTipus $csomszerForgHoz
     */
    ...
    /**
     * True, ha a Neta tv-ben meghatározott adókötelezettség az adó alanyát
     * terheli.
     *
    ...
    /**
     * A jövedéki terméket belföldön terhelő adót fel kell tüntetni (összes
     * adó).
     *
    ...
    /**
     * Adóraktár engedélyese/importáló/bejegyzett kereskedő/jöv. engedélyes
     * kereskedő az általa megfizetett, vételárban felszámított adót
     * elkülönítve kell, hogy feltüntesse a vevő kérésére.
     *
    ...
    /**
     * Gázolaj beszerzéséről szóló számlán a kereskedelmi jármű forgalmi
     * rendszámát és a kilóméteróra állását is fel kell tüntetni.
     *
     * @property \Dream\NavInvoiceExport\Data\GazolajBeszerzTipus $gazolajBeszerz
     */
    private $gazolajBeszerz = null;

    /**
     * Ha true, akkor meg kell adni a jövedéki termék vámtarifaszámát, a
     * jövedéki engedélye számát,
     *  a vevő adóigazgatási azonosító számát, és adott esetben a vevő
    ...
    /**
     * A jövedéki engedélyes kereskedő jövedéki termék értékesítésekor a
     * számlán fel kell tüntetnie
     *  a jövedéki engedélye számát, a vevő adóigazgatási azonosító számát,
     * és adott esetben a vevő őstermelői igazolvány számát.
     *
     * @property \Dream\NavInvoiceExport\Data\JovEngKereskJovErtTipus
     * $jovEngKereskJovErt
     */
    private $jovEngKereskJovErt = null;

    /**
     * "True, ha továbbértékesítés esetén a jövedéki termék származásának
    ...
    /**
     * True, ha importáló a számlán köteles feltüntetni a jövedéki termék
     * vámtarifaszámát.
     *
    ...
    /**
     * A rezsicsökkentés eredményeként jelentkező megtakarítás összegét fel
     * kell tűntetni jól láthatóan, színes mezőben.
     *
    ...
    /**
     * A beszállókártya számát a tranzitadóraktár-engedélyes az
     * értékesítésről kiállított
     *  számlán köteles feltüntetni. Beszállókártyának minősül minden olyan
     * okmány, amely tartalmazza a járatszámot,
     ...
     *
     * @property \Dream\NavInvoiceExport\Data\BeszallokartyaTipus $beszallokartya
     */
     ...
     * pontja…..)alpontja alapján a vevőt terheli".
     *
     * @return \Dream\NavInvoiceExport\Data\TermekdijSzerzesAtvallalasTipus
     */
     ...
     * pontja…..)alpontja alapján a vevőt terheli".
     *
     * @param \Dream\NavInvoiceExport\Data\TermekdijSzerzesAtvallalasTipus
     * $termekdijSzerzesAtvallalas
     * @return self
     */
    public function setTermekdijSzerzesAtvallalas(\Dream\NavInvoiceExport\Data\TermekdijSzerzesAtvallalasTipus $termekdijSzerzesAtvallalas)
    {
     ...
     *  kötelezett adószáma.
     *
     * @return \Dream\NavInvoiceExport\Data\VisszIgenyTipus
     */
     ...
     *  kötelezett adószáma.
     *
     * @param \Dream\NavInvoiceExport\Data\VisszIgenyTipus $visszIgeny
     * @return self
     */
    public function setVisszIgeny(\Dream\NavInvoiceExport\Data\VisszIgenyTipus $visszIgeny)
    {
     ...
     * nyilatkozata alapján nem kerül megfizetésre".
     *
     * @return \Dream\NavInvoiceExport\Data\CsomszerForgHozTipus
     */
     ...
     * nyilatkozata alapján nem kerül megfizetésre".
     *
     * @param \Dream\NavInvoiceExport\Data\CsomszerForgHozTipus $csomszerForgHoz
     * @return self
     */
    public function setCsomszerForgHoz(\Dream\NavInvoiceExport\Data\CsomszerForgHozTipus $csomszerForgHoz)
    {
     ...
     * rendszámát és a kilóméteróra állását is fel kell tüntetni.
     *
     * @return \Dream\NavInvoiceExport\Data\GazolajBeszerzTipus
     */
     ...
     * rendszámát és a kilóméteróra állását is fel kell tüntetni.
     *
     * @param \Dream\NavInvoiceExport\Data\GazolajBeszerzTipus $gazolajBeszerz
     * @return self
     */
    public function setGazolajBeszerz(\Dream\NavInvoiceExport\Data\GazolajBeszerzTipus $gazolajBeszerz)
    {
     ...
     * és adott esetben a vevő őstermelői igazolvány számát.
     *
     * @return \Dream\NavInvoiceExport\Data\JovEngKereskJovErtTipus
     */
     ...
     * és adott esetben a vevő őstermelői igazolvány számát.
     *
     * @param \Dream\NavInvoiceExport\Data\JovEngKereskJovErtTipus $jovEngKereskJovErt
     * @return self
     */
    public function setJovEngKereskJovErt(\Dream\NavInvoiceExport\Data\JovEngKereskJovErtTipus $jovEngKereskJovErt)
    {
     ...
     *  Beszállókártya szám alatt ezen adatok együttes adatát kell érteni.
     *
     * @return \Dream\NavInvoiceExport\Data\BeszallokartyaTipus
     */
     ...
     *  Beszállókártya szám alatt ezen adatok együttes adatát kell érteni.
     *
     * @param \Dream\NavInvoiceExport\Data\BeszallokartyaTipus $beszallokartya
     * @return self
     */
    public function setBeszallokartya(\Dream\NavInvoiceExport\Data\BeszallokartyaTipus $beszallokartya)
    {
