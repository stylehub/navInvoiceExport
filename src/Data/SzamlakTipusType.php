...
/**
 * Class representing SzamlakTipusType
 *
 * 
 * XSD Type: szamlak_tipus
 */
class SzamlakTipusType
{
     ...
     *
     * @property \Dream\NavInvoiceExport\Data\SzamlaTipusType[] $szamla
     */
    private $szamla = array(
     ...
     *
     * @return self
     * @param \Dream\NavInvoiceExport\Data\SzamlaTipusType $szamla
     */
    public function addToSzamla(\Dream\NavInvoiceExport\Data\SzamlaTipusType $szamla)
    {
        $this->szamla[] = $szamla;
        return $this;
    }
     ...
     * Az egyes számlák adatait tartalmazza.
     *
     * @return \Dream\NavInvoiceExport\Data\SzamlaTipusType[]
     */
